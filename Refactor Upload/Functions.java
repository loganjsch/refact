    ...
    */
    ...
    public static void parseEntity(WorldModel world, String line, ImageStore imageStore) {
        ...
        if (properties.length >= Functions.ENTITY_NUM_PROPERTIES) {
            ...
            switch (key) {
                case Functions.OBSTACLE_KEY -> WorldModel.parseObstacle(world, properties, pt, id, imageStore);
                case Functions.DUDE_KEY -> WorldModel.parseDude(world, properties, pt, id, imageStore);
                case Functions.FAIRY_KEY -> WorldModel.parseFairy(world, properties, pt, id, imageStore);
                case Functions.HOUSE_KEY -> WorldModel.parseHouse(world, properties, pt, id, imageStore);
                case Functions.TREE_KEY -> WorldModel.parseTree(world, properties, pt, id, imageStore);
                case Functions.SAPLING_KEY -> WorldModel.parseSapling(world, properties, pt, id, imageStore);
                case Functions.STUMP_KEY -> WorldModel.parseStump(world, properties, pt, id, imageStore);
